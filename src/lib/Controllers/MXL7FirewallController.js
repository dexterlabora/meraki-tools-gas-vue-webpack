...
class MXL7FirewallController {
     ...
     * 'https://api.meraki.com/api/v0/networks/[networkId]/l7FirewallRules'
     * ```
     *
     ...
     * @returns {Promise}
     */
    static getNetworkL7FirewallRules(networkId, callback) {
        ...
        let _pathUrl = '/networks/{networkId}/l7FirewallRules';
...
module.exports = MXL7FirewallController;
