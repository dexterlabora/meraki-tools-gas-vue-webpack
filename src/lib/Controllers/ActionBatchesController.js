...
class ActionBatchesController {
     ...
     * 'https://api.meraki.com/api/v0/organizations/[organizationId]/actionBatches/[id]'
     * ```
     *
     ...
     * @returns {Promise}
     */
    static deleteOrganizationActionBatch(organizationId, id, callback) {
     ...
     * @returns {Promise}
     */
    static getOrganizationActionBatch(organizationId, id, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * ```
     * curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X GET
     * 'https://api.meraki.com/api/v0/organizations/[organizationId]/actionBatches'
     * ```
     *
     * @param {string} organizationId TODO: type description here
     *
     ...
     *
     * @param {string} organizationId TODO: type description here
     * @param {Body} body (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createOrganizationActionBatches(organizationId, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param {string} organizationId TODO: type description here
     * @param {string} id TODO: type description here
     * @param {Body1} body (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateOrganizationActionBatch(organizationId, id, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
