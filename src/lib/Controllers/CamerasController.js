...
class CamerasController {
    /**
     * Returns a link to a snapshot of what the camera sees at the specified time.
     * ## SAMPLE REQUEST
     * ```
     ...
     * @param {Body5} body (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createSnapshotNetworkCamera(networkId, serial, body, callback) {
