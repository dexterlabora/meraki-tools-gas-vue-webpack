...
class SAMLRolesController {
     ...
     * @param {Body38} body (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateOrganizationSamlRole(organizationId, id, body, callback) {
     ...
     * @returns {Promise}
     */
    static createOrganizationSamlRoles(organizationId, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
