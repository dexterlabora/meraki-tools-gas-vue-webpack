...
class PhoneNumbersController {
     ...
     * 'https://api.meraki.com/api/v0/networks/[networkId]/phoneNumbers/available'
     * ```
     *
     ...
     * @returns {Promise}
     */
    static getNetworkPhoneNumbersAvailable(networkId, callback) {
        ...
        let _pathUrl = '/networks/{networkId}/phoneNumbers/available';
     ...
     * ```
     * curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X GET
     * 'https://api.meraki.com/api/v0/networks/[networkId]/phoneNumbers'
     * ```
     *
     * @param {string} networkId TODO: type description here
     *
     ...
     * @returns {Promise}
     */
    static getNetworkPhoneNumbers(networkId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _pathUrl = '/networks/{networkId}/phoneNumbers';
        // process template parameters
        _pathUrl = _apiHelper.appendUrlWithTemplateParameters(_pathUrl, {
            networkId,
        });
