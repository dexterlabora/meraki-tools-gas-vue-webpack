...
class SplashSettingsController {
     ...
     * @returns {Promise}
     */
    static getNetworkSsidSplashSettings(networkId, number, callback) {
     ...
     * @param {string} networkId TODO: type description here
     * @param {string} number TODO: type description here
     * @param {Body56} body (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateNetworkSsidSplashSettings(networkId, number, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
