...
class ContentFilteringCategoriesController {
     ...
     * 'https://api.meraki.com/api/v0/networks/[networkId]/contentFiltering/categories'
     * ```
     *
     ...
     * @returns {Promise}
     */
    static getNetworkContentFilteringCategories(networkId, callback) {
        ...
        let _pathUrl = '/networks/{networkId}/contentFiltering/categories';
...
module.exports = ContentFilteringCategoriesController;
